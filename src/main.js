...
function renderSurprisePage() {
  ...
  app.innerHTML = `
    ...
    <div class="w-full max-w-md sm:max-w-lg mx-auto space-y-6 select-none animate-fade-in pb-16">
      ...
      <div class="pt-2">
        <button onclick="renderPasscodeScreen()" class="w-full bg-purple-900/40 hover:bg-purple-800/60 border border-purple-500/30 text-purple-300 hover:text-white font-medium py-3.5 px-6 rounded-2xl text-xs tracking-wide transition-all active:scale-95 shadow-md flex items-center justify-center space-x-2">
          <span>↺</span>
